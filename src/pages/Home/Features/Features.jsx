...
const Features = () => {
  return (
    <div className="relative bg-yellow-500/20">
          ...
          <div className="flex items-center justify-center w-full order-2 lg:order-1 lg:w-7/12">
            <div className="h-full px-4 pt-7 md:pt-24 pb-16 sm:px-6 lg:px-12 2xl:px-24 lg:pb-24">
              <div className="flex flex-col justify-between flex-1 h-full">
                <div>
                  <h6 className="text-2xl text-rose-600 font-semibold font-amita">
                    Our Features
                  </h6>
                  <h1 className="text-4xl mt-4 font-amaranth font-bold text-black sm:text-6xl xl:text-7xl">
                    What You Get
                  </h1>
                  <p className="mt-6 text-base text-black sm:text-xl font-amaranth ">
                  ...
                  <ul className="mt-8 flex flex-col gap-8">
                    ...
                    <li className="flex gap-5 sm:gap-7">
                      ...
                      <div>
                        {" "}
                        <h3 className="text-xl sm:text-2xl font-medium font-amaranth mb-2">
                          Memories & Friendship
                        </h3>
                        <p className="font-amaranth text-sm sm:text-base">
